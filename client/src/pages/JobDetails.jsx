                ...
                <div className='bg-white shadow-lg rounded-lg p-6 mb-8'>
                  <div className='flex flex-col md:flex-row gap-6 items-start md:items-center'>
                    <div className='w-24 h-24 md:w-32 md:h-32 flex items-center justify-center bg-gray-50 rounded-lg p-2'>
                      <img src={jobDetails.companyLogo.url} className='max-w-full max-h-full object-contain' alt={jobDetails.companyName} />
                    </div>
                    <div className='flex flex-col gap-3'>
                      ...
                      <p className='text-lg flex items-center gap-2'>
                        <BsPersonWorkspace size={20} className="text-gray-600" />
